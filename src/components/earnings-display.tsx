  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-blue-600">{formatCurrency(monthlyEarnings)}</div>
          <p className="text-xs text-muted-foreground">
            Earnings this month
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-purple-600">{formatCurrency(weeklyEarnings)}</div>
          <p className="text-xs text-muted-foreground">
            Earnings this week
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-orange-600">{formatCurrency(dailyEarnings)}</div>
          <p className="text-xs text-muted-foreground">
            Earnings today
          </p>
        </CardContent>
